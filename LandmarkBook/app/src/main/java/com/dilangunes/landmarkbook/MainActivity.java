...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bitmap colleseo = BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.colosseum);
       ...
       final ArrayList<Bitmap> landmarkImages = new ArrayList<>();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //Toast.makeText(getApplicationContext(), landmarkNames.get(i), Toast.LENGTH_LONG).show();
                //Toast.makeText(getApplicationContext(), countryNames.get(i), Toast.LENGTH_LONG).show();
                Intent intent = new Intent(getApplicationContext(),DetailActivity.class);
                intent.putExtra("name",landmarkNames.get(i));
                intent.putExtra("countryNames",countryNames.get(i));
                //intent.putExtra("images",landmarkImages.get(i));

                Singleton singleton = Singleton.getInstance();
                singleton.setChosemImage(landmarkImages.get(i));
